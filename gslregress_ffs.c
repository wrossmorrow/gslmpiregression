...
int main( int argc , char * argv[] ) 
{
	...
	if( p == 0 ) {
		...
		// here we can free the data to allocate it specifically for the worker-like process below
		free( params.data );
		...
		printf( "%0.6f: estimated coeffs: %0.3f" , MPI_Wtime()-start , ((s->x)->data)[0] );
